<template>
  <el-dialog
    ...
    <el-input class="inputDesc" :autosize="{ minRows: 1, maxRows: 6 }" type="textarea" placeholder="添加照片说明..."
              v-model="imageDescription"></el-input>
  </el-dialog>
</template>
...
<script>
  export default {
    ...
    methods: {
      ...
      backendReq: function (url, data, config) {
